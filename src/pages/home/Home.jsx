        ...
        <div className="home-main">
            <Container maxWidth="lg">
                ...
                <Grid container spacing={3} justifyContent="center" mt={2}>
                    <Grid item xs={12} md={4}>
                        <Card className='home-card' onClick={() => navigate('/password')}>
                            ...
                            <Typography variant="body2" align="center" paragraph>
                                Test the strength of your passwords with our password validation tool. Ensure your accounts stay secure with robust password practices. It can rate your password strength.
                            </Typography>
                        </Card>
                    </Grid>
                    <Grid item xs={12} md={4}>
                    ...
                    <Grid item xs={12} md={4}>
                        <Card className='home-card' onClick={() => navigate('/calulator')}>
                            <Typography variant="h6" align="center" gutterBottom>Calculator</Typography>
                            <Typography variant="body2" align="center" paragraph>
                                Crunch numbers with ease using our sleek calculator. Whether you're balancing your budget or solving complex equations, our calculator makes math a breeze.
                            </Typography>
                        </Card>
                    </Grid>
                    <Grid item xs={12} md={4}>
                        <Card className='home-card' onClick={() => navigate('/bmi')}>
                            ...
                            <Typography variant="body2" align="center" paragraph>
                                Stay on top of your health goals with our BMI calculator. Track your body mass index and monitor your progress towards a healthier lifestyle.
                            </Typography>
                        </Card>
                    </Grid>
                    <Grid item xs={12} md={4} onClick={() => navigate('/calculator')}>
                        <Card className='home-card'>
                            ...
                            <Typography variant="body2" align="center" paragraph>
                                Need to perform more advanced calculations? Our arithmetic calculator handles complex mathematical operations with precision and efficiency.
                            </Typography>
                        </Card>
                    </Grid>
                    <Grid item xs={12} md={4}>
                        <Card className='home-card' onClick={() => navigate('/todo')}>
                            <Typography variant="h6" align="center" gutterBottom>Todo Lists</Typography>
                            <Typography variant="body2" align="center" paragraph>
